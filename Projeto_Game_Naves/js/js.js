function start() {
    ...
    // Verifica usuário pressionou alguma tecla
    ...
    } //Fim da função que movimenta o fundo
    ...
    function movejogador() {
        if (jogo.pressionou[TECLA.W]) {
            ...
            if (topo<=0) {  //Testa se o helicóptero chegou ao teto. Caso sim, aumenta o topo e trava.
                $("#jogador").css("top",topo+10);
            }
        }
        ...
        if (jogo.pressionou[TECLA.S]) {
            ...
            if (topo>=434) {  //Testa se o helicóptero chegou ao chão. Caso sim, diminui o topo e trava.
                $("#jogador").css("top", topo-10);
            }
        }
    ...
    //Função que movimenta o inimigo1 - helicóptero amarelo
    ...
    }// Fim da função que move inimigo1
    ...
    function disparo() {
        if (podeAtirar == true) {
            ...
            tiroX = posicaoX + 180;
            topoTiro = topo+50;
            $("#fundoGame").append("<div id='disparo'></div>");  //append insere um comando html no js, neste caso, cria uma div com id disparo.
    ...
    } //Fim da função que reposiciona o inimigo2
	...
	function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia'><button class='iniciar' onClick=reiniciaJogo()>Jogar Novamente</button></div>");
